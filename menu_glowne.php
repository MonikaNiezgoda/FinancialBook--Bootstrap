			  ...
			  <div class="collapse navbar-collapse" id="navbarToggler">
				<ul class="navbar-nav mr-auto ml-3  mt-lg-0">
				  <li class="nav-item active">
					<a class="nav-link" href="strona_glowna.html"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house-fill" viewBox="0 0 16 16">
				  ...
				  <li class="nav-item">
					<a class="nav-link" href="dodaj_przychod.html"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cash-coin" viewBox="0 0 16 16">
				  ...
				  <li class="nav-item">
					<a class="nav-link " href="przegladaj_bilans.html"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bar-chart-fill" viewBox="0 0 16 16">
					...
					<div class="container">
					 <div class="row mt-2">
						 <div class="col-md-4 text-center">
								<img src="img/facet.jpg" class="img-fluid" alt="kciuk">
								</div>
							<div class="col-md-8 text-center mt-2">
								<h2> Witaj!</h2>
								<p> Cieszę się, że zacząłeś ogarniać swoje finanse z pomocą tej aplikacji!</p>
									<p>Co chciałbyś teraz zrobić?</p>
							</div>
						</div>
					 </div>
